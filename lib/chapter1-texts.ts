// Chapter 1 translations sourced from bopsecrets.org/gateway/passages/tao-te-ching.htm
// 185 translations with original line breaks preserved

export interface Chapter1Entry {
  name: string
  date: string
  text: string
}

export const CHAPTER1_TRANSLATIONS: Chapter1Entry[] = [
  {
    name: `John Chalmers`,
    date: `1868`,
    text: `The tau (reason) which can be tau-ed (reasoned) is not the Eternal
Tau (Reason).
...
This sameness (or existence and non-existence) I call the abyss — the abyss of
abysses — the gate of all mystery.`,
  },
  {
    name: `Frederick Henry Balfour`,
    date: `1884`,
    text: `The TAO, or Principle of Nature, may be discussed [by all]; it is
not the popular or common Tao.

Its Name may be named [i.e., the TAO may receive a
designation, though of itself it has none]; but it is not an ordinary name, [or
name in the usual sense of the word, for it is a presentment or of the
Infinite].
...
It is therefore in habitual passionlessness [the Quiescent phase of TAO]
that its mystery may be scanned; and in habitual desire [the Active phase of TAO]
that its developments may be perceived.

These two conditions, the Active and the Quiescent, alike proceed [from TAO];
it is only in name that they differ. Both may be called profundities; and the
depth of profundity is the gate of every mystery.`,
  },
  {
    name: `James Legge`,
    date: `1891`,
...
Mystery is the deepest is the gate of all that is subtle and wonderful.`,
  },
  {
    name: `G.G. Alexander`,
    date: `1895`,
    text: `God (the great everlasting infinite First Cause from whom all things in heaven
and earth proceed) can neither be defined nor named.

For the God which can be defined or named is but the Creator, the Great Mother
of all those things of which our senses have cognisance.

Now he who would gain a knowledge of the nature and attributes of the nameless
and undefinable God, must first set himself free from all earthly desires, for
unless he can do this, he will be unable to penetrate the material veil which
interposes between him and those spiritual conditions into which he would obtain
an insight.

Yet the spiritual and the material, though known to us under different names,
are similar in origin, and issue from the same source, and the same obscurity
belongs to both, for deep indeed is the darkness which enshrouds the portals
through which we have to pass, in order to gain a knowledge of these mysteries.`,
  },
  {
    name: `P.J. Maclagan`,
    date: `1898`,
    text: `A Tao that can be tao-ed is not lasting Tao.
...
These two are the same; once there is out-going, then there is difference of
name.

As the same they are called obscure. The obscure of the obscure is the gate
of all mysteries.`,
  },
  {
    name: `T.W. Kingsmill`,
    date: `1899`,
    text: `The way that may be traversed is not the Eternal WAY. The name which can be
uttered is not the Eternal NAME.

Without name — Heaven and Earth (Nature) at the beginning were called the
mother of all things. Thus it always is that (he who is) without passion can
grasp the inner essence, while (he who is blinded) by passion can only apprehend
the outer form. These two have really the same issue, and differ only in name.
Together they are spoken of as the First Cause. The cause of the First Cause
itself is the gateway of the Essential.`,
  },
  {
    name: `I.W. Heysinger`,
    date: `1903`,
    text: `The way that can be overtrod is not the Eternal Way,
...
The deep of deeps, from whose eternal gate all spirit came.`,
  },
  {
    name: `E.H. Parker`,
    date: `1903`,
    text: `The Providence which could be indicated by words would not be an all-embracing
Providence, nor would any name by which we could name it be an ever-applicable
name.

"Non-existence" is a name for the beginning of heaven and earth. "Existence"
is a name for the genetrix of the innumerable objects of creation.

Hence, "absolute non-existence" suggests to us the miraculous working of what
in "absolute existence" has become the resulting essence.

These two emanate from the same, though their namings are dissimilar, and
jointly they are termed "state of colourless dissolution." Dissolution, again,
within dissolution this connects us with the various miraculous workings.`,
  },
  {
    name: `Lionel Giles`,
    date: `1904`,
    text: `The Tao which can be expressed in words is not the eternal Tao; the name which
can be uttered is not its eternal name. Without a name, it is the Beginning of
Heaven and Earth; with a name, it is the Mother of all things. Only one who is
eternally free from earthly passions can apprehend its spiritual essence; he who is ever
clogged by passions can see no more than its outer form. These two things, the
spiritual and the material, though we call them by different names, in their
origin are one and the same. This sameness is a mystery, — the mystery of
mysteries. It is the gate of all spirituality.`,
  },
  {
    name: `Walter Gorn Old`,
    date: `1904`,
    text: `The Tao that is the subject of discussion is not the true Tao.
...
Therefore doth the wise man seek after the first mystery of the Non-Existent,
while seeing in that which exists the Ultimates thereof.

The Non-Existent and Existent are identical in all but name.

This identity of apparent opposites I call the profound, the great deep, the
open door of bewilderment.`,
  },
  {
    name: `C. Spurgeon Medhurst`,
    date: `1905`,
    text: `The Tao which can be expressed is not the unchanging Tao; the name which can be
named is not the unchanging name.

The nameless is the beginning of Heaven and Earth; the mother of all things is
the nameable.

Thus, while the eternal non-being leads toward the fathomless, the eternal being
conducts to the boundary. Although these two (the Tao and its twofold aspect)
have been differently named they come from the same.

As the same they may be described as the abysmal. The abyss of the abysmal is
the gate of all mystery.`,
  },
  {
    name: `Richard Wilhelm`,
    date: `1910`,
    text: `The DAO that can be expressed
...
is the gateway through which all miracles emerge.`,
  },
  {
    name: `Léon Wieger`,
    date: `1913`,
    text: `The Principle that can be enunciated is not the one that always was. The being
that can be named is not the one that was at all times. Before time, there was
an ineffable, unnameable being.

When it was still unnameable, it conceived Heaven and Earth. When it had thus
become nameable, it gave birth to the multitude of beings.

These two acts are but one, under different denominations. The unique act of
generation; that is the mystery of the beginning; the mystery of mysteries; the
door through which have issued, onto the scene of the universe, all of the
marvels which it contains.

The knowledge that man has of the universal Principle depends on his state of
mind. The mind habitually free from passion knows its mysterious essence; the
habitually passionate mind knows only its effects.`,
  },
  {
    name: `D.T. Suzuki and Paul Carus`,
    date: `1913`,
    text: `The Reason that can be reasoned is not the eternal Reason. The name that can be
named is not the eternal Name. The Unnameable is of heaven and earth the
beginning. The Nameable becomes of the ten thousand things the mother.
...
These two things are the same in source but different in name. Their sameness is
called a mystery. Indeed, it is the mystery of mysteries. Of all spirituality it
is the door.`,
  },
  {
    name: `Isabella Mears`,
    date: `1916`,
    text: `The Tao that can be expressed
...
Door of many mysteries.`,
  },
  {
    ...
    date: `1918`,
    text: `The Tao-Path is not the All-Tao. The Name is not the Thing named.

Unmanifested, it is the Secret Father of Heaven and Earth; manifested, it is
their Mother.

To understand this Mystery, one must be fulfilling one's will, and if one is not
thus free, one will but gain a smattering of it.

The Tao is one, and the Teh but a phase thereof. The abyss of this Mystery is
the Portal of Serpent-Wonder.`,
  },
  {
    name: `Dwight Goddard`,
    date: `1919`,
    text: `The Tao that can be understood cannot be the primal, or cosmic, Tao, just as an
idea that can be expressed in words cannot be the infinite idea.
...
spirituality; and to desire is to learn the limitation of matter. These two
things spirit and matter, so different in nature, have the same origin. This
unity of origin is the mystery of mysteries, but it is the gateway to
spirituality.`,
  },
  {
    name: `Tom MacInnes`,
    date: `1927`,
    text: `The doing that can be done is not the regular doing. The significance that can
be signified is not the everlasting significance. The Divine that can be
divined is not the Eternal Divine. Yet there is a lasting way beyond land and
sea and sky which may be indicated. There is the Heavenly Way leading clear to
the clear. Striving to go right ahead right I would tell now of the Heavenly
Way.

What then is this Heavenly Way? What is this Divine which may
be divined; and this Eternal Divine which cannot be divined? The Divine which
may be divined is the Ever Moving Presence in the Never Moving. Rounding all
moving is space. Rounding all sound is silence. But if we call this the
Eternal Divine we say nothing.

I have no full name for the Heavenly Way. Some talk of the
breath of the valley; some talk of the vim of vacancy. I know there is one
pure power. Through every item of existence while it exists the one pure power
will be coming and going on the double wing of the instant. There is a domain
that is formal; and a domain numeral; and a domain moral. There may be other
domains utterly diverse in the knowing of them. The valid presence of the pure
power may be known through all domains. But because of its diversity in mode
of manifestation we devise for it many names. Yet ever there is a way of
unfoldment in line with the pure power; and in that there may be a return to
that which is before every domain and every mode of existence.`,
  },
  {
    name: `Charles H. Mackintosh`,
    date: `1926`,
    text: `The way to which mankind may hold
...
To that from whence he came.`,
  },
  {
    name: `Arthur Waley`,
    date: `1934`,
    text: `The Way that can be told of is not an Unvarying Way;
...
The Doorway whence issued all Secret Essences.`,
  ...
  {
    name: `Bhikshu Wai-tao and Dwight Goddard`,
    date: `1935`,
    text: `The TAO that can be "tao-ed" can not be the infinite TAO (that is, the way
that can be followed can not be the ultimate, pathless Way). It is the same with
the name of things: if things are explicable, the names we give them can not be
the original Name. (That is) The source of the universe is hidden in
non-existence; existence is only the mother of its evolution.

Since human beings are a small likeness of the great Universe, they can only
realize their Taohood by making close imitations of it. Before one can attain
the supreme perfection of Taohood, he must first realize its inmost mystery,
that is, he must enter the door of this mystery of mysteries.

There are two ways for effecting this realization, both of which can be followed
by the human organism. One way to realize the wonderful mystery of TAO is to put
away all thoughts and desires. The other way is to concentrate both true
intention and sincere devotion. These two ways of realization have different
names but they both lead to a realization of the mystery that we call TAO.`,
  },
  {
    name: `Edwin Denby`,
    date: `ca. 1935`,
    text: `IT, if nameable, is not eternal. The name, nameable, is not eternal name. The
Nameless is the root of Heaven and Earth, while that that can be named is the
Mother of all beings. Therefore he who is without sees it within, he who wants,
its boundaries. These two are of one end, though of different name. Unseparated,
they are called dark, the Dark's doubly Dark, the Gate of all Reason.`,
  },
  {
    name: `Ch'u Ta-Kao`,
    date: `1937`,
    text: `The Tao that can be expressed is not the eternal Tao;
...
From eternal non-existence, therefore, we serenely observe the mysterious
...
This sameness is called profundity. Infinite profundity is the gate whence comes
the beginning of all parts of the universe.`,
  },
  {
    name: `Derke Bodde`,
    date: `1937`,
    text: `The Tao that may be called Tao is not the invariable Tao. The
names that can be named are not the invariable names. Non-being is the term
given to the form from which Heaven and Earth sprang. Being is the term
given to the mother that rears the ten thousand things (on earth). Of the
invariable Non-being, we wish to see its secret essences. Of the invariable
Being, we wish to see its borders. These two have issued together but are
different in name. The two together we call the Mystery. It is the Mystery
of Mysteries, the doorway of all secret essences.`,
  },
  {
    name: `John C.H. Wu`,
    date: `1939`,
    text: `Tao can be talked about, but not the Eternal Tao.
...
The Mystery of mysteries is the Door of all essence.`,
  },
  {
    name: `Lin Yutang`,
    date: `1942`,
    text: `The Tao that can be told of
...
Is the Gate to the Secret of All Life.`,
  },
  {
    name: `Witter Bynner`,
    date: `1944`,
    text: `Existence is beyond the power of words
...
Existence opens.`,
  },
  {
    name: `Hermon Ould`,
    date: `1946`,
    text: `The Tao that can be expressed is not the
Unchanging Tao;

The name that can be named is not the Unchanging name.

The Unnameable is that from which Heaven and Earth derived, leaving itself
unchanged.

Thinking of it as having a name, let it be called the Mother of all things.

He who is without earthly passions and without desire can perceive the
profound mystery of that Unmanifested
Existence.

He who has not rid himself of desire can perceive only the Manifest, with its
differentiations.

Nevertheless, the Manifest and the Unmanifest are in origin the same.

This sameness is the Mystery of Mysteries, the deep within the deep, the
Doorway into all Mystery.`,
  },
  {
    name: `Frederick B. Thomas`,
    date: `1948`,
    text: `The Tao that can be named
...
The doorway to the Secret of all Life.`,
  },
  {
    name: `Orde Poynton`,
    date: `1949`,
    text: `A way that can be described is not the Eternal Way:
...
When two things that were one are differentiated they are then given different
names.

Unity may be called "the Enigma" — "the Mystery of Mysteries" — "the Portal of
the Secret Essence."`,
  },
  {
    name: `Cheng Lin`,
    date: `1949`,
    text: `The truth that may be told is not the everlasting Truth.

The name given to a thing is not the everlasting Name.

Nothingness is used to denote the state that existed before the birth of heaven
and earth.

Reality is used to denote the state where the multitude of things begins to have
...
They are the most mysterious, and form the gateway to all mysteries.`,
  },
  {
    ...
    date: `1954`,
    text: `The Way that may truly be regarded as the Way is other than a permanent way.

The terms that may truly be regarded as terms are other than permanent terms.

The term Non-being indicates the beginning of heaven and earth; the term Being
indicates the mother of the ten thousand things.
...
What they have in common is called the Mystery, The Mystery of Mysteries, the
Gate of all Wonders.`,
  },
  {
    name: `R.B. Blakney`,
    date: `1955`,
    text: `There are ways but the Way is uncharted;
...
The gate to the root of the world.`,
  },
  {
    name: `Archie J. Bahm`,
    date: `1958`,
    text: `Nature can never be completely described, for such a description of Nature would
have to duplicate Nature.

No name can fully express what it represents.

It is Nature itself, and not any part (or name or description) abstracted from
Nature, which is the ultimate source of all that happens, all that comes and
goes, begins and ends, is and is not.

But to describe Nature as "the ultimate source of all" is still only a
description, and such a description is not Nature itself. Yet since, in order to
speak of it, we must use words, we shall have to describe it as "the ultimate
source of all."

If Nature is inexpressible, he who desires to know Nature as it is in itself
will not try to express it in words.

To try to express the inexpressible leads one to make distinctions which are
unreal.

Although the existence of Nature and a description of that existence are two
different things, yet they are also the same.

For both are ways of existing. That is, a description of existence must have its
own existence, which is different from the existence of that which it describes;
and so again we have to recognize an existence which cannot be described.`,
  },
  {
    name: `Frank J. MacHovec`,
    date: `1962`,
    text: `The Tao described in words is not the real Tao. Words cannot describe it.
Nameless it is the source of creation; named it is the mother of all things.

To see Tao the observer must be motiveless. Those with selfish
motives see only the surface, not the innermost depths. These two kinds of
observers look alike but differ in the insight of their observations.

They look alike because they are both human; within humanity is
the key to the door of creation.`,
  },
  {
    name: `D.C. Lau`,
    date: `1963`,
    text: `The way that can be spoken of
...
The gateway of the manifold secrets.`,
  },
  {
    name: `Wing-Tsit Chan`,
    date: `1963`,
    text: `The Tao that can be told of is not the eternal Tao;
...
The door of all subtleties.`,
  ...
  {
    name: `Timothy Leary`,
    date: `Psychedelic Prayers, 1966`,
    text: `That Which Is Called The Tao Is Not The Tao
...
through this Gate . . . . . of All Wonder`,
  ...
  {
    name: `Peter A. Boodberg`,
    date: `1968`,
    text: `Lodehead lodehead-brooking : no forewonted lodehead;
...
Desired — for to descry in view the
minikin-subliminaria,
...
The thronging subliminaria's gate.`,
  },
  {
    name: `Tang Zi-chang`,
    date: `1969`,
    text: `Dao that can be talked about is not the eternal Dao itself;
...
The gate to all mystery.`,
  ...
  {
    name: `Chang Chung-yuan`,
    date: `1975`,
    text: `The Tao that can be spoken of is not the Tao itself.
...
The entry of all wonders!`,
  },
  {
    name: `Paul J. Lin`,
    date: `1977`,
    text: `The Tao that can be spoken of is not the eternal Tao;
...
The gate of all subtleties.`,
  },
  {
    name: `Hua-Ching Ni`,
    date: `1979`,
    text: `Tao, the subtle reality of the universe
...
the Gate of All Wonders.`,
  },
  {
    name: `K.O. Schmidt`,
    date: `1979`,
    text: `The Tao that can be named is not the absolute Tao.

The name that can be uttered is not the name of the Eternal.

As the unmanifest it is the origin of heaven and earth; manifest it is the
mother of all beings.

Whoever free from attachment looks inward with detachment attains the vision
of the Unmanifest;
...
This unity is the mystery of the Tao the unfathomable of the primordial ground
the starting point of all manifestation.`,
  },
  {
    name: `D. Howard Smith`,
    date: `1980`,
    text: `That which can be thought of as Tao (lit. Tao that can be tao'd) is not the
absolute Tao. Whatever name that can be applied is not its absolute name.
Nameless, it is the source of heaven and earth. Named, it is the mother of all
things. Therefore, considered as absolute "non-being" we desire to see into
its mystery; as absolute "being" we desire to observe its limitations. These
two (non-being and being), though identical in origin, emerge under different
names. Their common identity is called mysterious, mystery of mysteries, the
gate of all mystery.`,
  },
  {
    name: `John R. Leebrick`,
    date: `1980`,
    text: `The way that can be told is not the eternal way. The name that can be named is
not the eternal name. The nameless is the beginning of heaven and earth. The
named is the mother of the ten thousand things.

Therefore, give up your desires if you would observe its secrets. Keep your
desires if you would observe its manifestations. These two are the same, but
diverge in name as they issue forth. Being the same, they are called profound;
profound and more profound, gateway to all mystery.`,
  },
  {
    name: `Tam C. Gibbs`,
    date: `1981`,
    text: `The tao that can be said is not the everlasting Tao.
...
The mystery of the Mysterious is the gateway to all indescribable marvels.`,
  ...
  {
    name: `Rhett Y.W. Young and Roger T. Ames`,
    date: `1981`,
    text: `The Tao which can be spoken of is not the eternal Tao;
...
With vision, they are recognized as one.`,
  },
  {
    name: `Henry Wei`,
    date: `1982`,
    text: `The Tao that can be stated is not the Eternal Tao.
...
the gateway to all mystery.`,
  },
  {
    name: `Alan B. Taplow`,
    date: `1982`,
    text: `The true Tao escapes definition,
...
The threshold of all secrets.`,
  },
  {
    name: `Stan Rosenthal`,
    date: `1984`,
    text: `Even the finest teaching is not the Tao itself.
...
and so experience the Tao.`,
  ...
  {
    name: `Herrymon Maurer`,
    date: `1985`,
    text: `If Tao can be Taoed, it's not Tao.
...
Mystery of mystery, the door to inwardness.`,
  },
  {
    name: `John Heider`,
    date: `1985`,
    text: `Tao means how: how things happen, how things work.
...
meditation, or being aware of what is happening. By being aware of what is
happening, I begin to sense how it is happening. I begin to sense Tao.

To become aware of what is happening, I must pay attention with an open mind. I
must set aside my personal prejudices or bias. Prejudiced people see only what
fits those prejudices.

The method of meditation works, because principle and process
are inseparable. All process reveals the underlying principle. This means that I
can know Tao. I can know God.
...
The gateway to the Collective Subtlety.`,
  },
  {
    name: `Shi Fu Hwang`,
    date: `1987`,
    text: `The Tao is that on which one can always tread.
...
Hence, those who are constantly free of desire of fame shall see the Tao's
subtle secret.

Those who bear desire shall see the end lying in front of them.

Both two types of men ferment their thinking in the same place, yet they will
experience different fates.

Both their fates shall be up to Heaven.

Beyond our heaven, there are other heavens: whoever knows this shall find the
gate of the Tao.`,
  },
  {
...
The gateway to all understanding.`,
  },
  {
    ...
    date: `1989`,
    text: `As for the Way, the Way that can be spoken of is not the constant Way;
...
Therefore, those constantly without desires, by this means will perceive its
subtlety.

Those constantly with desires by this means will see only that which they yearn
for and seek.
...
The gateway of all subtleties.`,
  },
  {
    name: `A.C. Graham`,
    date: `1989`,
    text: `The Way that can be "Way"-ed
...
Is the gate of the sublime in everything.`,
  },
  {
    name: `Ellen M. Chen`,
    date: `1989`,
    text: `Tao that can be spoken of,
...
The door to all hidden mysteries.`,
  },
  {
    name: `Yi Wu`,
    date: `1989`,
    text: `The way that can be talked about is not the constant Way.
...
It is the gateway to myriad subtleties.`,
  },
  {
    name: `Victor H. Mair`,
    date: `1990`,
    text: `The ways that can be walked are not the eternal Way;
...
The gate of all wonders!`,
  },
  {
    name: `Thomas Cleary`,
    date: `1991`,
    text: `A way can be a guide, but not a fixed path;
...
is the gateway of marvels.`,
  },
  {
    ...
    date: `1992`,
    text: `The Tao that can be told is not the invariant Tao
...
Therefore, the subtleties of Tao are always apprehended through their
formlessness,
...
The deepest and the most profound, the door of all mysteries.`,
  ...
  {
    name: `Man-Ho Kwok, Martin Palmer and Jay Ramsay`,
    date: `1993`,
    text: `The Tao that can be talked about is not the true Tao.
...
She is the gateway and the womb-door.`,
  },
  {
    ...
    date: `1993`,
    text: `TAO called Tao is not TAO.
...
The gateway to all mystery.`,
  ...
  {
    name: `He Guanghu, Gao Shining, Song Lidao and Xu Junyao`,
    date: `1993`,
    text: `The Tao that can be spoken of is not the eternal Tao;
...
The deepest and the most profound, the door of all mysteries.`,
  ...
  {
    name: `Patrick E. Moran`,
    date: `1993`,
    text: `A way (dao) that one can be directed along is not the constant Dao. A name that
...
So, It is always by desirelessness that one sees the hidden (noumenal)
aspect, and always by being in a state of having desires that one observes the
outer (phenomenal) aspect. These two [aspects of all reality] emerge together
and are differently named. Together, they are called the dark and mysterious.
The most dark and mysterious of the dark and mysterious Is the portal of the
multitudinous wonders.`,
  },
  {
    name: `Jerry O. Dalton`,
    date: `1994`,
    text: `The Tao of words is not the transcendental Tao.
...
Where the mystery is most profound is the gateway to all mystery.`,
  },
  {
    name: `Ron Hogan`,
    date: `1994`,
    text: `If you can talk about it, it ain't Tao.
...
Figure them out, and you've got it made.`,
  ...
  {
    name: `John Louis Albert Trottier`,
    date: `1994`,
    text: `TAO (THE LAWS OF THE UNIVERSE) can be talked about,
...
It is in all ways greater and more subtle than the world.)`,
  },
  {
    ...
    date: `1994`,
    text: `Of the Dao it must be said: Let no man name It.
...
Cleanse yourself from Lust of Result (Expectation) and you will see without
constriction.

Remain ensnared in its grip, and you will only see the wall you have erected
in front of you.
...
of everything's oneness.`,
  },
  {
    name: `Peter Merel`,
    date: `1995`,
    text: `The Way that can be experienced is not true;
...
The womb giving birth to all of being.`,
  },
  {
    name: `Gu Zhengkun`,
    date: `1995`,
    text: `The Tao that is utterable
...
Hence one should gain an insight into the beginning of the Tao by constantly
observing the Nothingness,

And should perceive the end of the Tao by constantly observing the Being.

These two things, the Nothingness and the Being, are of the same origin but
different in name.
...
The beginning of all understanding.`,
  },
  {
    name: `Sanderson Beck`,
    date: `1996`,
    text: `The Way that can be described is not the absolute Way;
...
is the door to the essence of all life.`,
  ...
  {
    name: `Brian Browne Walker`,
    date: `1996`,
    text: `Tao is beyond words
...
This is the beginning of all understanding.`,
  },
  {
    ...
    date: `1996`,
    text: `The way that becomes a way
...
the door to all beginnings`,
  },
  {
    name: `Richard Hooker`,
    date: `1996`,
    text: `The Tao that can be trodden is not the enduring and unchanging Tao. The name
that can be named is not the enduring and unchanging name.

Having no name, it is the Originator of heaven and earth; having a name, it
...
place, it receives the different names. Together we call them the Mystery. Where
the Mystery is the deepest is the gate of all that is subtle and wonderful.`,
  },
  {
    name: `Edwin Sha`,
    date: `1996`,
    text: `The tao (way) that can be told
...
The gateway to all subtlety.`,
  },
  {
    name: `Alan Fox`,
    date: `1996`,
    text: `Daos can dao, but they are not constant (fixed, predictable) daos

Designations can designate, but they are not constant (fixed, predictable)
designations
...
It is usually the case that, having no preferences, one observes subtle
profundity

It is usually the case that, having preferences, one observes superficial
...
The gateway into all wonder.`,
  },
  {
    name: `Charles Muller`,
    date: `1997`,
    text: `The Tao that can be followed is not the eternal Tao.
...
The door to all marvels.`,
  },
  {
    name: `Tormond Byrn`,
    date: `1997`,
    text: `The way that can be told of is hardly an eternal, absolute, unvarying one;

the name that can be coded and given is no absolute name.

Heaven and earth sprang from something else: the bright nameless;

the named is but the said mother that rears the ten thousand creatures of heaven
...
Still the two are the same; the secret and its manifestations came from the same
ground, the same mould, but anyway sound different —
...
There's the deeper mystery: the gate and doorway from which issued all secret
essences, yes, all subtleties,
...
Call it the door mystery or golden secret of all life.`,
  ...
  {
    name: `John WorldPeace`,
    date: `1997`,
    text: `The infinity that can be conceived is not the
...
the essence of Infinity.`,
  },
  {
    name: `Eva Wong`,
    date: `1997`,
    text: `The Tao that can be spoken of is not the real way.
...
Is the gateway to all wonders.`,
  ...
  {
    name: `Stephen F. Kaufmann`,
    date: `1998`,
    text: `The true way is unknown and so is the untrue way
...
The door to the hidden.`,
  ...
  {
    name: `Eiichi Shimomissé`,
    date: `1998`,
    text: `The Tao that refers to here can never be the mundane tao.
...
To understand this is the gate to all mysteries.`,
  },
  {
    name: `Jerry C. Welch`,
    date: `1998`,
    text: `The Finite cannot be all of the Infinite!
...
the Gate of all wonders!`,
  ...
  {
    name: `Gregory C. Richter`,
    date: `1998`,
    text: `The Dao which one can explain is not the unchanging Dao.
...
Therefore one should always emphasize nothingness if one desires to observe the
marvelousness of the Dao;

one should always emphasize existence if one desires to observe the limits of
the Dao.
...
they are the gate of all marvelous things.`,
  ...
  {
    name: `Richard John Lynn`,
    date: `1999`,
    text: `The Dao that can be described in language is not the constant Dao; the name that
can be given is not its constant name.

Nameless, it is the origin of the myriad things; named, it is the mother of the
myriad things.

Therefore, always be without desire so as to see their subtlety. And always have
desire so as to see their ends.

These two emerge together but have different names. Together, we refer to them
as mystery: the mystery upon mystery and gateway of all subtleties.`,
  },
  {
    name: `Richard Degen`,
    date: `1999`,
    text: `There are things that cannot be described by or understood through language. A
complete description and understanding of the purpose and operation of the Way
is beyond the power of language.

Whether you try to reason your way through life or act through emotion, the
words associated with each path can be traps, not bridges, because they hide
what is common to each: the presence of mystery.`,
  },
  {
    name: `Timothy Freke`,
    date: `1999`,
    text: `Tao is not a way that can be pointed out.
...
as mystery; the mystery upon mystery and gateway of all subtleties.`,
  ...
  {
    name: `Ralph D. Sawyer and Mei-chun Lee Sawyer`,
    date: `1999`,
    text: `The Tao that can be spoken of is not the ineffable Tao.
...
The gate to a myriad etherealities.`,
  },
  {
    name: `George Cronk`,
    date: `1999`,
    text: `The Tao that can be defined is not the real Tao.
...
and yet it is the way to all wisdom.`,
  ...
  {
    name: `Lee Sun Chen Org`,
    date: `2000`,
    text: `Tao (Truth) can be talked about (theorized in any manner each person considers
viable), though hardly of these theories will be eternally valid;

Names (Descriptions) can be ascribed [to Tao in any fashion each person deems
workable], yet hardly of these names (descriptions) will last forever.

The beginning of the Universe (Heaven and Earth) [is beyond us, so in all
honesty it] is indescribable;

[Nevertheless,] whatever is namable (describable) by us served as the mother
(origin) of [our knowledge of] myriad (all and every) things and creatures.

Accordingly,

I constantly refrain from my selfish (subjective) desires for the purpose of
exploring its (Nature's) manifested (apparent) wonder;

I also constantly maintain my will [to seek objective knowledge] in order to
pursue its (Nature's) deep-seated enigma.

These two (Tao and Te) were originated from the same source, but they were
described with different names by us.

They are both depicted as profound [as each is intricate in its own right];

The profundity (complexity) intensifies as we fathom its mystery further and
deeper;
...
Eventually, it will [lead us] to the gateway of all mysteries.`,
  },
  {
    name: `David Hinton`,
    date: `2000`,
    text: `A Way become Way isn't the perennial Way.
...
gateway of all mystery.`,
  },
  {
    name: `Jim Clatfelter`,
    date: `2000`,
    text: `Words and names are not the way
...
And possibility entire`,
  ...
  {
    name: `Gerald Schoenewolf`,
    date: `2000`,
    text: `Ways can be told,
...
The gateway to eternity opens wide.`,
  },
  {
    name: `Ted Wrigley`,
    date: `2000`,
    text: `A path is just a path, a name is just a name
...
A perception from which all spirituality springs`,
  },
  {
    name: `Ichin Shen`,
    date: `2000`,
    text: `Tao that can be described is not the constant Tao.
...
[intuitive comprehension is] the gateway to all mysteries [of Tao].`,
  },
  {
    name: `Moss Roberts`,
    date: `2001`,
    text: `The Way as "way" bespeaks no common lasting Way,
...
The milling seed germs teem.`,
  },
  {
    ...
    date: `2001`,
    text: `The way of ways is not the true Way.
...
the gate to the essence of everything!`,
  },
  {
    name: `Jeff Rasmussen`,
    date: `2001`,
    text: `Spoken Tao is not eternal Tao
...
Gateway to all understanding.`,
  },
  {
    name: `David H. Li`,
    date: `2001`,
    text: `Direction, as expressed, is no ordinary direction;
...
Profound upon profound, it is the portal to all intricacies.`,
  },
  {
    name: `Tien Cong Tran`,
    date: `2001`,
    text: `The way that can be talked about is not the eternal Way.
...
These two flow from the same source, though differently named; and both are
called mysteries.
...
That is the door of all wonders.`,
  },
  {
    name: `Stephen Hodge`,
    date: `2002`,
    text: `Any dao given by language
...
in our journey toward transcendence.`,
  ...
  {
    name: `Chou-Wing Chohan, Abe Bellenteen and Rosemary Brant`,
    date: `2002`,
    text: `The Tao that can be expressed in words is not the eternal Tao.
...
From eternal non-existence, therefore, we observe the beginning of the existence
of the many hidden qualities of the universe.

From eternal existence, therefore, we clearly observe the overt qualities of the
universe.

These two, the hidden and the overt, are originally the same at source, and
become different where they manifest themselves.

This same origin is "the smallest of the small."

The absolute "smallest of the small" is the gate from which the beginning of
all the parts of the universe emerges.`,
  },
  {
    name: `Octavian Sarbatoare`,
    date: `2002`,
    text: `The Way (Tao) that can be named, is not the Ultimate Way.
...
From where everything comes into existence.`,
  },
  {
    name: `Karl Kromal`,
    date: `2002`,
    text: `The perceived Way is not the eternal Way.
...
the gateway to understanding.`,
  },
  {
    name: `Xiaolin Yang`,
    date: `2002`,
    text: `The DAO can be talked about, but that is not the ever-lasting DAO.
...
you should stay in existence if you want to see the different entities of the
world.
...
Understanding the XUANs is the key to the kingdom of truth.`,
  },
  {
    name: `Lok Sang Ho`,
    date: `2002`,
    text: `Ways that can be spelled out
...
such is the gateway to all versatility.`,
  ...
  {
    name: `Douglas Allchin`,
    date: `2002`,
    text: `Who would follow the Way
...
existence opens.`,
  ...
  {
    name: `Alan Sheets and Barbara Tovey`,
    date: `2002`,
    text: `The
Tao is the unobstructed breath.

The Tao holds the opposing forces of the eternal Tao.

The
Name is the unobstructed breath.
...
If
you are eternally without deep-seated desires, then you perceive its mystery.

If you have deep-seated desires, then you perceive its outer form.

These both (the essence and outer form) have the same origin but have different
names.
...
All people are at the door of this mysterious One.`,
  ...
  {
    name: `Philip J. Ivanhoe`,
    date: `2003`,
    text: `A Way that can be followed is not a constant Way.
...
The gate of all mysteries!`,
  ...
  {
    name: `Roger T. Ames and David L. Hall`,
    date: `2003`,
    text: `Way-making that can be put into words is not really way-making,
...
Thus, to be really objectless in one's desires is how one observes the
mysteries of all things,

While really having desires is how one observes their boundaries.

These two — the nameless and what is named — emerge from the same source yet
...
They are the swinging gateway of the manifold mysteries.`,
  ...
  {
    name: `Roderic Sorrell and Amy Max Sorrell`,
    date: `2003`,
    text: `The Tao can be explained,
but this is not the real Tao.
...
The doorway to all wonders.`,
  },
  {
    name: `Chichung Huang`,
    date: `2003`,
    text: `A tao that can be spoken about
...
Therefore, ever desireless, one can see the
mystery.
...
The gate of many secrets.`,
  },
  {
    name: `Han Hiong Tan`,
    date: `2003`,
    text: `Dao that can be expressed in words is not the absolute Dao.
...
And it is through these perspectives that we can observe the marvellous
phenomena of Nature.`,
  },
  {
    name: `Ha Poong Kim`,
    date: `2003`,
    text: `No Tao that may be Tao is the constant Tao;
...
The gate to myriad secrets.`,
  ...
  {
    name: `enlightenedbuddha.com`,
    date: `2004`,
    text: `The Way cannot be said in words.
...
The entry to all understanding lies in this paradox.`,
  },
  {
    name: `thetao.info`,
    date: `2004`,
    text: `The "Tao" is too great to be described by the name "Tao."

If it could be named so simply, it would not be the eternal Tao.

Heaven and Earth began from the nameless
(Tao),

but the multitudes of things around us were created by names.

We desire to understand the world by giving
names to the things we see,
...
The cause and the effects are aspects of the
same, one thing.

They are both mysterious and profound.

At their most mysterious and profound point lies the "Gate of the Great
Truth."`,
  },
  {
    name: `Chad Hansen`,
    date: `2004`,
    text: `To guide what can be guided is not constant guiding.
...
the gateway of a crowd of mysteries.`,
  },
  {
    name: `truetao.org`,
    date: `2004`,
    text: `The Tao that can be spoken is not the constant Tao
...
Mystery of mysteries, the door to all wonders`,
  },
  {
    ...
    date: `2004`,
    text: `This book can tell you nothing;
...
It opens into the center of everything.`,
  ...
  {
    name: `Stanley Atamanchuk`,
    date: `2004`,
    text: `The TAO that can be spoken is not the forever TAO.
...
When you are trapped by desire you see only the physical side of things . . .
the manifestations.
...
Nothingness within nothingness the pathway to understanding all.`,
  },
  {
    name: `Maury Merkin`,
    date: `2004`,
    text: `The way that can be shown is not the Eternal Way.
...
The Gateway to Salvation.`,
  },
  {
    name: `Thomas Z. Zhang`,
    date: `2004`,
    text: `If Tao can be described, then it is not general Tao.
...
Theorizing and evolving these theories is the gate to marvels.`,
  },
  {
    name: `Hilmar Klaus`,
    date: `2004`,
    text: `A dao that can be defined,
...
the Gate to all Mysteries.`,
  },
  {
    ...
    date: `2004`,
    text: `Alas this very spoken Dao
...
and every mystery's door.`,
  ...
  {
    name: `Yasuhiko Genku Kimura`,
    date: `2004`,
    text: `The Tao Eternal is beyond definition.
...
Both mysteries and appearance come from the same origin but wear a different
name;
...
The greatest mystery is the gate to all mysteries.`,
  },
  {
    ...
    date: `2005`,
    text: `Tao: speak the tao. It is not the eternal tao.
...
To understand the mysteries of DAO, empty yourself of all
desire;

to understand its outward forms, fill yourself
with all desire.

DAO and the world flow from the same source, but differ in
name.
...
(Is) the gateway to every mystery`,
  },
  {
    name: `Brian Donohue`,
    date: `2005`,
    text: `The Cosmic Consciousness described
...
Through the gateway of your own heart.`,
  ...
  {
    name: `Agnieszka Solska`,
    date: `2005`,
    text: `The Tao you can tell is not the true Tao.
...
The gateway to the essence of all.`,
  ...
  {
    name: `Tony Barnstone and Chou Ping`,
    date: `2005`,
    text: `The Dao that
can be told is not the timeless Dao.
...
gateway of untold secrets.`,
  },
  {
    name: `Hu Xuezhi`,
    date: `2006`,
    text: `The Tao that can be spoken of is not the eternal
Tao.
...
Mystery of mysteries, the door to all wonders`,
  },
  {
    name: `Keith H. Seddon`,
    date: `2006`,
    text: `The Tao that can be put in words is not the ever-abiding Tao;
...
The threshold to all secrets.`,
  },
  {
    name: `Nina Correa`,
    date: `2007`,
    text: `Dao may be accepted as "Dao", but
that would conflict with the constant motion of Dao.

A name may be accepted as a "Name", but that would conflict with the constant motion of
what's been given a name.

Everything started out without needing to be named or categorized.

When they were seen as things that needed to be nurtured, they were
then given names.

Therefore:

When we're in the frame of mind of not wanting anything, we look at even the
smallest things as being significant.
...
they're thought to be quite different.

Trying to fit them together is said to be one of the most profound
mysteries.

That's the doorway to even more mysteries.`,
  },
  {
    name: `Mikhail Mikolenko`,
    date: `2007`,
    text: `One cannot know Tao only by speaking about It.

One cannot name by human name that
Origin of the sky and earth Which is the Mother of everything.

Only he who is free from worldly
passions can see It; and he who has such passions can see only Its Creation.

Tao and Its Creation are One in
essence though called by different names. The passage which exists between them
is the door to all the miraculous.`,
  },
  {
    name: `Sam Hamill`,
    date: `2007`,
    text: `Tao defined is not the constant Tao.
...
and the mystery itself is the gateway to perception.`,
  },
  {
    ...
    date: `2012`,
    text: `The
Dao that can be defined is not the eternal Dao; and the name of the Dao that can
be given is not the name of the eternal Dao.

Nothing is what the universe begins with; and something is the mother of all
things.

Thus through nothingness we are able to observe Dao's subtlety; and through
somethingness we are able to see its boundary.

The two come from the same source yet with different names. Both of them are
described as profundities, but Dao is even more profound, and a gateway to all
mysteries.`,
  },
  {
    name: `William Scott Wilson`,
    date: `2012`,
    text: `The Way that can be articulately described
...
your vision is beset by all the things around
you.
...
This is the gate to all mysteries.`,
  },
  {
    name: `Rick Julian`,
    date: `2013`,
    text: `Words won't bring you to me
...
Where questions and answers whisper`,
  },
  {
    ...
    date: `2013`,
    text: `The Way that can be spoken of is not
the eternal Way;
...
wanting thisgives rise to that.

Beyond named and nameless,
reality still flows;
...
unfathomable the arch, the door, the gate.`,
  },
  {
    name: `dragonfly`,
    date: `2015`,
    text: `the Profound Mystery of the Infinite Eternal Tao can never be elucidated

even using the name Tao is attempting to name That which inherently cannot be named

the Unfathomable conceives the illusion of separation/duality — space/time,
within/without, seeking/finding

clothed with form and name, the Primal Creative Feminine constantly generates the myriad things

sincerely seeking within the brightest light, one is entirely immersed in
duality and illusion

searching deeply inside for Truth continually perpetuates the delusion of
separation

there is no within/inside, nowhere to go, nothing to find, see, hear,
believe or do
...
Source`,
  ...
  {
    name: `Thanks Always Returns`,
    date: `2015`,
    text: `Tao given as Tao isn't Tao Eternal
...
In the dark within the dark lies the threshold of awareness`,
  },
  {
    name: `C. Ganson`,
    date: `date unknown`,
    text: `The Tao described in words is not the real Tao.
...
Within humanity is the key to the door of creation.`,
  },
  {
    name: `Tienzen Gong`,
    date: `date unknown`,
    text: `Tao that can be spoke of, not the eternal Tao.
...
Both may be called the Mystery.`,
  },
  {
    name: `Andre Gauthier`,
    date: `date unknown`,
    text: `The spirit one can talk about is not the eternal spirit, and what you can name
is not the eternal name. Nameless-Tao is the beginning of the heavens and the
Earth. If you name it — it is no more than Matter.

Therefore: he who conceives of nature freely grasps this Spirit
and he who strives for material things is left with only the shell. Spirit and
matter are both one in their origin, yet different in appearance. This unity is
a mystery — truly the mystery of all mysteries, the
gate to all spirituality.`,
  },
  {
    name: `Bao Pu`,
    date: `date unknown`,
    text: `A Dao which can be spoken, is
not an enduring Dao. [OR
Daos can guide, but they are not enduring Daos/guides.]

A name which can be named, is not an enduring name. [OR
...
The gateway to a multitude of profound subtleties.`,
  ...
  {
    name: `Sonja Elen Kisa`,
    date: `date unknown`,
    text: `The Flow of the universe is not one you can explain,
...
Gateway to all wonders.`,
  },
  {
    ...
    date: `date unknown`,
    text: `The Way (Tao) that can be told of is not an unvarying Way;
...
Which is infinitely greater and more subtle than the World.`,
  ...
  {
    name: `Steven Ericsson Zenith`,
    date: `date unknown`,
    text: `The TAO that can be expressed in words is not the all-embracing and immutable
TAO: the Name that can be spoken is not the eternal Name. Without a name, It
is the Beginning of The Universe and Our World: conceived as having a name, It
is the Progenitrix of all things. Those alone who are free from earthly
passions can perceive the deep mystery of the Unmanifested One: those who are
possessed by desires can only behold the Manifest's outward form. These two,
the Manifest and the Unmanifest, although differing in name, in essence are
identical. This sameness is the mystery, the deep within the deep, the door of
many mysteries.`,
  },
  {
    name: `rivenrock.com`,
    date: `date unknown`,
    text: `The Tao that is spoken of, cannot be truly explained.

The grandest eloquence cannot define it.

It has no name, and is the creator of Heaven and Earth.

Forced to name it, we can call it the Tao (the Way), and accept that it is
great.

When we are lost in desire we can see only the outer manifestations of this
greatness.
...
The Mystery and the Manifestations are separate, yet they arise from the same
source.
...
Yet mystery and manifestations arise from the same source. This source is
called darkness.
...
The gateway to all understanding.`,
  },
  {
    name: `David Tuffley`,
    date: `date unknown`,
    text: `The Tao that can be expressed is not the Tao of the Absolute.
...
Thus, without expectation, one will always perceive the
subtlety;
...
The gateway to the collective subtlety.`,
  },
  {
    ...
    date: `date unknown`,
    text: `The tao that can be taoed
...
it is the gateway to all wizardry.`,
  },
  {
    name: `David Bullen`,
    date: `date unknown`,
    text: `Words cannot describe the
Tao, and The Tao cannot be named. That which is eternal is unnameable. Naming
is the basis of things. Free from desire you are a mystery. Caught in desire
you are known. The mystery and the known are not separate. It is naming which
separates us. Only through paradox can you understand.`,
  },
  {
    name: `gospelofthomas.fol.nl`,
    date: `date unknown`,
    text: `The Ineffable, about which is spoken, is not the eternal Ineffable
...
Will pass through the narrow gate and receive the secret of true life`,
  ...
  {
    name: `Edward Brennan and Tao Huang`,
    date: `date unknown`,
    text: `The Tao that is voiced is no longer that of eternal Tao.
...
And here exists a metaphysical door to true wisdom.`,
  },
  {
    name: `Cheng`,
    date: `date unknown`,
    text: `Tao that can be described is not the universal and eternal Tao;
...
Is the door to all wonders.`,
  ...
  {
    name: `John Emerson`,
    date: `translation in progress`,
    text: `A way can be shown: it is not the constant way.
...
export function getChapter1(translatorName: string): Chapter1Entry | undefined {
  return CHAPTER1_TRANSLATIONS.find(t => t.name === translatorName)
}